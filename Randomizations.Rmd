...
diffdf<-lapply(splitts,function(x){
...
```{r}
ggplot(nullframe[nullframe$Metric=="mean",],aes(x=Difference)) + geom_density(fill="black") + geom_vline(data=mtruestate[mtruestate$Metric=="mean",],aes(xintercept=Difference),linetype="dashed",col="red") + facet_wrap(~Hummingbird,scales="free") + theme_bw()
```

## SD Trait-matching

```{r}
ggplot(nullframe[nullframe$Metric=="sd",],aes(x=Difference)) + geom_density(fill="black") + geom_vline(data=mtruestate[mtruestate$Metric=="sd",],aes(xintercept=Difference),linetype="dashed",col="red") + facet_wrap(~Hummingbird,scales="free") + theme_bw()
```
...
```{r}
ggplot(nullframe[nullframe$Metric=="min",],aes(x=Difference)) + geom_density(fill="black") + geom_vline(data=mtruestate[mtruestate$Metric=="min",],aes(xintercept=Difference),linetype="dashed",col="red") + facet_wrap(~Hummingbird,scales="free") + theme_bw()
```

## Max Trait-matching

```{r}
ggplot(nullframe[nullframe$Metric=="max",],aes(x=Difference)) + geom_density(fill="black") + geom_vline(data=mtruestate[mtruestate$Metric=="max",],aes(xintercept=Difference),linetype="dashed",col="red") + facet_wrap(~Hummingbird,scales="free") + theme_bw()
```

## Range Trait-matching
```{r}
ggplot(nullframe[nullframe$Metric=="range",],aes(x=Difference)) + geom_density(fill="black") + geom_vline(data=mtruestate[mtruestate$Metric=="range",],aes(xintercept=Difference),linetype="dashed",col="red") + facet_wrap(~Hummingbird,scales="free") + theme_bw()
```
