...
r.int<-permatfull(month.inter,times=100,fixed="rows")
...
p<-p+scale_fill_discrete(guide="none") + scale_x_date() + scale_size_continuous(range=c(2.5,5),"Observations") + labs(y="") + theme_bw() + scale_x_date(date_breaks="3 months",date_labels = "%m %y")
print(p) 
