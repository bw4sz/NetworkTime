...
* Range of hummingbird bill sizes (mm) ~ NBinom(2)
* Twenty plants
* Range of corolla sizes (mm) ~ NBinom(2)
...
initB<-matrix(nrow=h_species,ncol=plant_species,data=.1)
#Inits
