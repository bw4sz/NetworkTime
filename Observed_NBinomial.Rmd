---
title: Niche overlap increases with increasing resource availability in a tropical (NBinomial)
...
```{r}
#save.image("Observed_NBinomial.RData")
```
