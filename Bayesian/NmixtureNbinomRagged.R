...
sink("Bayesian/NmixtureNBinomRagged.jags")
...
cat("
    ...
    p[Bird[x],Plant[x],Time[x]] <- alpha[Bird[x]] + beta1[Bird[x]] * traitmatch[x] + beta2[Bird[x]] * resources[x] + beta3[Bird[x]] * resources[x] * traitmatch[x]      
    
    #True State
    N[x] ~ dnegbin(p[Bird[x],Plant[x],Time[x]],r[Bird[x]])
