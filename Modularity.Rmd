...
overall<-ggplot(mtweb,aes(y=Hummingbird,x=Iplant_Double,fill=as.factor(Availability))) + geom_tile()  + theme(axis.text.x = element_text(angle = 90, hjust = 1)) + xlab("Plant")
overall
