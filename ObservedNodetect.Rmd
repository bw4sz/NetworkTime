...
#index resources
resourceMatrix<-indat %>% group_by(jBird,jPlant,jTime) %>% summarize(v=unique(Used_Flowers)) %>% mutate(v=scale(v)) %>% acast(jBird ~ jPlant ~ jTime,value.var='v',fill=0)
...
list(beta1=initB,beta2=initB,beta3=initB,alpha=rep(.5,Birds),intercept=0,tau_alpha=0.1,tau_beta1=0.1,tau_beta2=0.1,tau_beta3=0.1,gamma1=0,gamma2=0,gamma3=0,Yobs=initY)}
