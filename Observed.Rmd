...
predy<-trajF(alpha=castdf$intercept,beta1=castdf$gamma1,x=Dat$traitmatch,resources=Dat$resources,beta2=castdf$gamma2,beta3=0,type='hdi')
...
for(d in 1:length(species.split)){
  ...
  #scale resources
  species.traj[[d]]<-trajF(alpha=x$alpha,beta1=x$beta1,beta2=x$beta2,beta3=x$beta3,resources=billd$FlowerA,x=billd$Traitmatch,type='hdi')
  }
...
for(d in 1:length(species.split)){
  ...
  species.traj[[d]]<-intF(alpha=dat$alpha,beta1=dat$beta1,x=billd$Traitmatch,resources=billd$FlowerA,beta2=dat$beta2,beta3=dat$beta3,type='hdi')
