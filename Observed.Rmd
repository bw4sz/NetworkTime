...
ni <- 250000  # number of draws from the posterior
nt <- 10  #thinning rate
...
#Trajectories from posterior
predH<-trajF(alpha=castdf$intercept,beta1=castdf$gamma1,x=obsf[obsf$BUsed_Flowers==1,"Traitmatch"],resources=obsf[obsf$BFlowerA==1,"BFlowerA"],beta2=castdf$gamma2,beta3=castdf$gamma3,type='hdi')
