...
ggplot(data=counts,aes(x=BFlowerA==1,y=n,fill=Visited))+ facet_wrap(~Hummingbird) + geom_bar(data=counts,stat = "identity",position = position_dodge()) + scale_x_discrete("Resource Availability",labels=c("Low","High")) + geom_text(aes(label=n),size=8,position = position_dodge(width=0.9,height=-.25))
```
