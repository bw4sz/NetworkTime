...
InitStage <- function(){list(beta1=initB,beta2=initB,detect=initB,beta4=initB,beta3=initB,alpha=initB,intercept=0,tau_alpha=0.1,tau_beta1=0.1,tau_beta2=0.1,tau_beta3=0.1,tau_beta4=0.1,gamma1=0,gamma2=0,gamma3=0,gamma4=0,N=Ninit)}

#Parameters to track
ParsStage <- c("alpha","beta1","beta2","beta3","intercept","sigma_int","sigma_slope1","sigma_slope2","sigma_slope3","sigma_slope4","gamma1","gamma2","gamma3","gamma4","detect","fit","fitnew","E")
...
ggplot(chi,aes(x=Species,y=Iplant_Double,fill=log(chisq))) + geom_tile() + theme_bw() + labs(fill="Chi-squared discrepancy") + theme(axis.text.x = element_text(angle = 90, hjust = 1)) + scale_fill_gradientn(limits=c(-10,10),colours=c("blue","white","red"))
```
