...
4. Species interactions are based on similarity in morphology and abundance of resources, with an interaction. As resources decrease, hummingbirds interact **more** with plant that match their bill length.
...
5. Species interactions are based on similarity in morphology and abundance of resources, with an interaction. As resources decrease, hummingbirds interact **less** with plant that match their bill length. 
...
* Model 4: As there are more available resources, birds choose resources less similiar from their bill lengths
* Model 5: As there are more available resources, birds choose resources more similar to their bill lengths

#Simulate Model 5

Add in incomplete sampling - some flowers are only in bloom 3/4 of the samples
